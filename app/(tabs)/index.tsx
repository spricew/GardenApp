  ...
  return (
    <View className="flex-1 bg-warm-canvas">
      ...
      <View className="px-6 pt-6 pb-4">
        <Text className="font-sans font-medium text-[15px] text-ash tracking-tight uppercase">
          {formatDateDisplay(today)}
        </Text>
        <Text className="font-display font-medium text-[44px] text-charcoal-primary leading-[1.09] tracking-[-1.14px] mt-2">
          Servicios de Hoy
        </Text>
      </View>
          ...
          >
            <Text
              className={`font-sans font-medium text-[14px] tracking-tight ${
                filter === item.value ? "text-white" : "text-midnight"
              }`}
            >
              {item.label}
            </Text>
